...
#define LCD_BITS                 8           // 4 for 4 Bit I/O Mode, 8 for 8 Bit I/O Mode
...
#define LCD_RW_PORT              PORTG       // Port for RW line (ONLY used if RW_LINE_IMPLEMENTED=1)
#define LCD_RW_PIN               0           // Pin for RW line (ONLY used if RW_LINE_IMPLEMENTED=1)
...
#define LCD_E_PORT               PORTG       // Port for E line
